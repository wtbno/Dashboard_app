...
import { XKongName, XKongPluginKeyAuth, XKongPluginRequestTermination, XKongPluginRequestValidator, XKongRouteDefaults, XKongServiceDefaults, XKongUpstreamDefaults } from './kong';
...
export declare type OA3SecurityRequirement = Record<string, any>;
...
export declare type OA3Server = {
    url: string;
    description?: string;
    variables?: Record<string, OA3ServerVariable>;
} & OA3ServerKubernetesTLS & OA3ServerKubernetesBackend & OA3ServerKubernetesService;
export interface OA3ResponsesObject {
    $ref?: string;
}
/** see: https://swagger.io/specification/#operation-object */
export declare type OA3Operation = {
    description?: string;
    summary?: string;
    ...
    servers?: OA3Server[];
} & Taggable & XKongName & XKongRouteDefaults & XKongPluginKeyAuth & XKongPluginRequestValidator;
declare type HTTPMethodPaths = Partial<Record<HttpMethodType | Lowercase<HttpMethodType>, OA3Operation>>;
/** see: https://swagger.io/specification/#path-item-object */
export declare type OA3PathItem = {
    $ref?: string;
    summary?: string;
    description?: string;
    servers?: OA3Server[];
    parameters?: OA3Reference | OA3Parameter;
} & HTTPMethodPaths & XKongName & XKongRouteDefaults & XKongPluginRequestValidator & XKongPluginKeyAuth;
/** see: https://swagger.io/specification/#paths-object */
export declare type OA3Paths = Record<string, OA3PathItem> & StripPath & XKongRouteDefaults;
...
/** see: https://swagger.io/specification/#security-scheme-object */
export declare type OA3SecurityScheme = OA3SecuritySchemeApiKey | OA3SecuritySchemeHttp | OA3SecuritySchemeOpenIdConnect | OA3SecuritySchemeOAuth2;
...
export declare type OpenApi3Spec = {
    openapi: string;
    info: OA3Info;
    paths: OA3Paths;
    servers?: OA3Server[];
