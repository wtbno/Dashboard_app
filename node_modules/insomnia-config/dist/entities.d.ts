...
export declare const INSOMNIA_CONFIG_FILENAME = "insomnia.config.json";
export declare type ConfigVersion = '1.0.0';
export declare type AllowedSettings = Partial<Pick<Settings, 'allowNotificationRequests' | 'disableUpdateNotification' | 'enableAnalytics' | 'disablePaidFeatureAds' | 'incognitoMode'>>;
/**
