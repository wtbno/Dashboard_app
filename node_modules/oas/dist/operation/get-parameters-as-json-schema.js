 ...
 */
module.exports = function (path, operation, oas, globalDefaults) {
    var _a;
    ...
    function getRequestBody() {
        var schema = getSchema(operation, oas);
    ...
    function getComponents() {
        ...
        var components = {};
        Object.keys(oas.components).forEach(function (componentType) {
            if (typeof oas.components[componentType] === 'object' && !Array.isArray(oas.components[componentType])) {
                ...
                Object.keys(oas.components[componentType]).forEach(function (schemaName) {
                    var componentSchema = cloneObject(oas.components[componentType][schemaName]);
