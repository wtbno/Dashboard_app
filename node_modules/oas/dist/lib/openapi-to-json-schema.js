    ...
    for (var i = 0; i < pointers.length; i += 1) {
        for (var ii = 0; ii < rev.length; ii += 1) {
            ...
            if ('example' in schema) {
                ...
                var ex = schema.examples[keys.shift()];
...
function toJSONSchema(data, opts) {
    ...
    ['allOf', 'anyOf', 'oneOf'].forEach(function (polyType) {
    ...
    if ('discriminator' in schema) {
        if ('mapping' in schema.discriminator && typeof schema.discriminator.mapping === 'object') {
            ...
            // `refLogger`.
            Object.keys(schema.discriminator.mapping).forEach(function (k) {
    ...
    if (globalDefaults && Object.keys(globalDefaults).length > 0 && currentLocation) {
        try {
            var userJwtDefault = jsonpointer.get(globalDefaults, currentLocation);
            if (userJwtDefault) {
