...
exports.id = 'insomnia-4';
exports.name = 'Insomnia v4';
exports.description = 'Insomnia export format 4';
const convert = rawData => {
    let data;
    try {
        data = yaml_1.default.parse(rawData);
    }
    catch (e) {
        return null;
    }
...
//# sourceMappingURL=insomnia-4.js.map